...
times 510 - ($ - $$) db 0   ; This line basically adds 0x00 byte to fill up until 510 bytes.
dw 0xaa55                   ; Magic number for BIOS to detect that this sector has a bootloader.